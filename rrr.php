...
<tr>
<td>txnid</td><td><input type="text" name="txnid" value="<?php echo $txnid=time().rand(1000,99999); ?>" /></td>
<td>Amount: </td>
...
<tr>
<td>Success URI: </td>
<td colspan="3"><input name="surl" value="http://localhost:8456/success.php" size="64"  /></td>
</tr>
<tr>
<td>Failure URI: </td>
<td colspan="3"><input name="furl" value="http://localhost:8456/fail.php"  size="64" /></td>
</tr>
<tr>
